...
import com.codezzz.mall.common.entity.UmsIntegrationConsumeSetting;
...
public interface UmsIntegrationConsumeSettingMapper extends BaseMapper<UmsIntegrationConsumeSetting> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) UmsIntegrationConsumeSetting entity);
}
