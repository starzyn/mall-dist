...
import com.codezzz.mall.common.entity.PmsProductAttributeCategory;
...
public interface PmsProductAttributeCategoryMapper extends BaseMapper<PmsProductAttributeCategory> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) PmsProductAttributeCategory entity);
}
