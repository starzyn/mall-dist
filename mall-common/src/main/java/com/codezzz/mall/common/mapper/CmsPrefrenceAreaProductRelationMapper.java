...
import com.codezzz.mall.common.entity.CmsPrefrenceAreaProductRelation;
...
public interface CmsPrefrenceAreaProductRelationMapper extends BaseMapper<CmsPrefrenceAreaProductRelation> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) CmsPrefrenceAreaProductRelation entity);
}
