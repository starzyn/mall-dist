...
import com.codezzz.mall.common.entity.UmsMemberMemberTagRelation;
...
public interface UmsMemberMemberTagRelationMapper extends BaseMapper<UmsMemberMemberTagRelation> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) UmsMemberMemberTagRelation entity);
}
