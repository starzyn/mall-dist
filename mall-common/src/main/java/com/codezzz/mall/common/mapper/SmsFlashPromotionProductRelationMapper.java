...
import com.codezzz.mall.common.entity.SmsFlashPromotionProductRelation;
...
public interface SmsFlashPromotionProductRelationMapper extends BaseMapper<SmsFlashPromotionProductRelation> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) SmsFlashPromotionProductRelation entity);
}
