...
import com.codezzz.mall.common.entity.UmsMemberProductCategoryRelation;
...
public interface UmsMemberProductCategoryRelationMapper extends BaseMapper<UmsMemberProductCategoryRelation> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) UmsMemberProductCategoryRelation entity);
}
