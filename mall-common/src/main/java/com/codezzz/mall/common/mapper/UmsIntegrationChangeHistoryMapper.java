...
import com.codezzz.mall.common.entity.UmsIntegrationChangeHistory;
...
public interface UmsIntegrationChangeHistoryMapper extends BaseMapper<UmsIntegrationChangeHistory> {
     ...
     * @return 受影响的数据量
     */
    int alwaysUpdateSomeColumnById(@Param(Constants.ENTITY) UmsIntegrationChangeHistory entity);
}
